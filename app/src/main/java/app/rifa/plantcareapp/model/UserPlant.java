package app.rifa.plantcareapp.model;
...
public class UserPlant implements Serializable {
    ...
    public int getDaysToClosestAction() {
        ...
        try {
            int daysFromWatering = daysFromLastAction(Objects.requireNonNull(DATE_FORMAT.parse(lastWatering)));
            int daysFromFertilizing = daysFromLastAction(Objects.requireNonNull(DATE_FORMAT.parse(lastFertilizing)));
            int daysFromSpraying = daysFromLastAction(Objects.requireNonNull(DATE_FORMAT.parse(lastSpraying)));
